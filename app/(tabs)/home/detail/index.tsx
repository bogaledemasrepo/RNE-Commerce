        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.contentSection}>
            ...
            <View style={styles.priceRow}>
              <Text style={styles.currentPrice}>${MOCK_PRODUCT.price.toFixed(2)}</Text>
                ...
                {MOCK_PRODUCT.colors.map((color) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.colorRing,
                        isSelected && styles.colorRingSelected,
                      ]}
            ...
            <View style={styles.optionGroup}>
              <View style={styles.sizeHeaderRow}>
                <Text style={styles.optionLabel}>
                  Select Size (EU): <Text style={styles.selectedOptionText}>{selectedSize}</Text>
                </Text>
                <TouchableOpacity>
        ...
        <View style={styles.bottomActionBar}>
          ...
          >
            <Text style={styles.buyNowText}>
              Buy Now • ${(MOCK_PRODUCT.price * quantity).toFixed(2)}
            </Text>
          </TouchableOpacity>
        </View>
      </View>
