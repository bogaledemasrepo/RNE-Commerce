  ...
  return (<SafeAreaView style={{ flex: 1, backgroundColor: COLORS.background }}>
    <ScrollView>
      ...
      <View style={{ padding: 8 }}>
        <View style={{ width: "100%", height: 48, borderRadius: 8, backgroundColor: "#fff", borderWidth: 1, borderColor: COLORS.border, display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 4 }}>
      ...
      <ScrollView style={{ padding: 8 }} horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 8 }}>
        {[1, 2, 3, 4, 5, 6].map(Item => (
          <View key={Item} style={{ width: 88, height: 100, display: "flex" }}>
            <View style={{ height: "84%", width: "100%", borderRadius: 8, borderWidth: 1, borderColor: COLORS.border }}></View>
      ...
      <View style={{ padding: 8, display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
        <View style={{ display: "flex", flexDirection: "row" }}>
          <View style={{ paddingHorizontal: 16, paddingVertical: 4, borderColor: COLORS.border, borderWidth: 1, borderRadius: 16, backgroundColor: "#04050fb7" }}>
            <Text style={{ color: "#fff", fontWeight: "bold" }}>For You</Text>
          </View>
          <View style={{ paddingHorizontal: 8, paddingVertical: 4, borderColor: COLORS.border, borderWidth: 1, borderRadius: 16, flexDirection: "row", gap: 4, marginHorizontal: 4 }}>
