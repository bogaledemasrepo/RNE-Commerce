...
export default function TabsLayout() {
  ...
  // Compute total item count (accounts for quantities if applicable)
      ...
      >
        ...
        <Tabs.Screen
          ...
          options={{
            title: 'Cart',
            tabBarLabel: 'Cart',
            // Only render the badge if there are items in the cart
...
const styles = StyleSheet.create({
  ...
  badgeStyle: {
    backgroundColor: '#EF4444', // Modern Red Badge
    color: '#FFFFFF',
    fontSize: 10,
    fontWeight: '700',
    lineHeight: 14,
